...
if (isset($_POST['submit'])) {
    try {
        ...
        $sql = "SELECT name FROM Sponsors S WHERE NOT EXISTS (SELECT T.tid FROM Teams T WHERE NOT EXISTS (SELECT R.tid FROM Sponsorship R WHERE R.tid = T.tid AND R.sid = S.sid AND R.donation >= :amt))";
